...
function App()
{
    return(
        <div className="poo">
            ...
            <p>
            WELCOME TO ALL  AND THANK YOU FOR REGISTERING WITH US! IT IS IMPORTANT THAT YOU REVIEW THIS AGREEMENT BECAUSE, BY ACCESSING THIS WEBSITE, BY PLACING AN ORDER WITH US BY TELEPHONE, EMAIL, FAX, OR THROUGH THIS WEBSITE, YOU ARE AGREEING TO THE TERMS AND CONDITIONS THAT GOVERN THE USE OF THE SITE AND THE TERMS UPON WHICH WE AGREE TO DELIVER TO YOU.
...
All Site content, design, text, graphics, and interfaces; the collection, selection, and arrangement thereof; and all software are the property of, or duly licensed to, All Seasons Grocery, LLC. Consent is granted to view all of such things for the sole purpose of placing an order with us. You are not authorized to save or collect any such information. Any other use of materials on this Site, including modification, distribution, or reproduction is strictly prohibited. You acknowledge that All Seasons Grocery and/or third-party content providers remain the owners of such material and that you do not acquire any of those ownership rights by downloading copyrighted material. All Seasons Grocery reserves the right to revoke your use of the Site.

 

<h3>TRADEMARKS</h3>
All Seasons Grocery, All Seasons Grocery, LLC, www.allseasonsgrocery.com, the All Seasons Grocery logo, graphics, trademarks, and/or trade dress of All Seasons Grocery are proprietary to All Seasons Grocery and may not be used by you for any reason. All other trademarks, service marks, product names, and company names or logos appearing on the Site are the property of their respective owners and you do not acquire any ownership rights in such marks, logos, or names by using this Site or our service.
...
You agree to defend, indemnify, and hold All Seasons Grocery harmless from any and all suits, actions, legal or administrative proceedings, claims, demands, damages, liabilities, and expenses, including attorney’s fees and costs, arising in connection with a violation of this Agreement by you or through use of your account.

 

<h3>MISCELLANEOUS</h3>
This Agreement is effective upon your acceptance as set forth herein and shall continue in full force and effect until terminated. All Seasons Grocery may suspend or terminate this Agreement or the All Seasons Grocery Service or remove or disable access to any portion of our service at any time for any reason with or without notice to you. If you do not agree with the terms of this Agreement, you may terminate your acceptance by emailing us at info@allseasonsgrocery.com and by no longer accessing our website. All Seasons Grocery reserves the right to collect fees and charges incurred before you cancel your service. In addition, you are responsible for any charges incurred to third-party vendors or content providers prior to your cancellation.
...
This Agreement and the Privacy Policy referred to herein represent your entire agreement with All Seasons Grocery regarding the use of the service and the Site. You agree that this Agreement is not intended to confer and does not confer any rights or remedies upon any person other than you and All Seasons Grocery. If any portion of this Agreement is held invalid or unenforceable, that portion shall be construed in accordance with applicable law as nearly as possible to reflect the original intention of the parties, and the remainder of this Agreement shall remain in full force and effect. The failure of either party to insist upon strict performance of any provision of this Agreement shall not be construed as a waiver of any provision or right. This Agreement shall be governed by the laws of the State of Utah without regard to its conflict of rules. You expressly agree that exclusive jurisdiction for any claim or dispute with All Seasons Grocery or relating in any way to your use of the service or the Site resides in the federal and state courts of Utah and you further expressly consent and agree to personal jurisdiction by the state and federal courts sitting in the State of Utah in connection with any such dispute, including any claim involving All Seasons Grocery. Any cause of action by you must be instituted within one year after the claim or cause of action has arisen, or be barred.

 

<h3>FUTURE AMENDMENTS</h3>
All Seasons Grocery may amend this Agreement at any time by posting the amended terms on our Site. All amended terms shall automatically be effective at the time they are initially posted on our Site. By accessing this Site after the effective date of any such amendment, you agree to be bound by any such revisions and should therefore periodically visit this page to determine the then current Agreement to which you are bound. Customers who prefer to place order by telephone agree to be bound by the terms of this Agreement, as amended from time to time. In all cases, as a condition of making deliveries to you, you agree to review this Agreement from time to time.
